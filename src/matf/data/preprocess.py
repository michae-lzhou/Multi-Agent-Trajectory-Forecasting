...
def load_scenario(file, neighbor_cap=None):
    ...
    focal_obs, focal_future = build_focal_tensors(focal)
    # print(focal_obs[:5])
    # print(focal_future[:5])
    n_obs = build_neighbor_tensors(neighbors_by_track, neighbor_cap)
    # print(n_obs.shape)
